...
转自：https://juejin.cn/post/7071446208107151368
...
## 1.2 和委托的区别
- 在委托外面包裹一层`Expression<>`就是表达式目录树
- 表达式目录树可以通过`Compile()`转换成一个委托
...
# 4.ExpressionVisitor解析Expression
## 4.1 Expression解析
